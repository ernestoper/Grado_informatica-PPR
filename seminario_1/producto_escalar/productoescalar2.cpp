/*
 ...
 Description : Tutorial 4. Producto escalar entre vectores.
         En este tutorial mostraremos como realizar una multiplicacion
         eficiente entre dos vectores de un tamaño especifico. Para
         facilitar la comunicacion, imponemos como restriccion que los
         vectores sean de tamaño multiplo al numero de procesos. Sin
         embargo si la entrada no lo es, se cambiara el valor a uno que
         si lo sea automaticamente.
         Como ejemplo ilustrativo, mostraremos como utilizar los vectores
         de la STL, en lugar de vectores nativos de C/C++.
 ============================================================================
 */
#include "mpi.h"
#include <vector>
